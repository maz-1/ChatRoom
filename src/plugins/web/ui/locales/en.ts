export const enChatRoom = {
  ...
  oauthClients: {
    title: "OAuth clients",
    subtitle:
      "Registered MCP OAuth clients, runtime access state, and client controls",
    summary: "{0} of {1} active",
    refresh: "Refresh clients",
    client: "Client",
    note: "Note",
    noNote: "No note",
    editNote: "Edit note",
    noteTitle: "Edit client note",
    noteHint: "Up to 1000 characters",
    saveNote: "Save note",
    redirectUris: "Redirect URIs",
    showAllRedirects: "Show all ({0})",
    collapseRedirects: "Collapse",
    createdAt: "Created",
    ...
    disabled: "Disabled",
    actions: "Actions",
    toggleDisabled: "Enable or disable {0}",
    revoke: "Revoke",
    revokeTitle: "Revoke OAuth client",
    revokeConfirm:
      "Revoke and delete {0}? The client record, access tokens, refresh tokens, and authorization codes will be removed immediately. This cannot be undone.",
    empty: "No OAuth clients are registered.",
    statuses: {
      active: "Active",
      disabled: "Disabled",
    },
